...
@Service
public class ScenarioTransactionService2 {
    ...
    @Transactional
    public Scenariotransaction updateTransaction(String transactionKey, Scenariotransaction updatedData) {
        Scenariotransaction existing = transactionRepository.findByTransactionKey(transactionKey)
            .orElseThrow(() -> new RuntimeException("Transaction not found with key: " + transactionKey));
